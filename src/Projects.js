...
const projectDescriptions = [
  ...
  "A Full-Stack Javascript Application where users upon creating an account, can login and create quizzes which could then ne shared with all other users present on the application. They can also add friends who they can message within the application and share results.",
